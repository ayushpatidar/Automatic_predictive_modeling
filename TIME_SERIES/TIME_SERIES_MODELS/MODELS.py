...
def TIME_SERIES_ALGO(df, bool_stat):
    ...
    try:
        ...
        # print(test_stationary(test, col))
        ...
        for i in ar_list:
            for j in ma_list:
                try:
                    ...
                    result_arima = sqrt(mean_squared_error(test[col].values, y_prd))
                    print(result_arima)
                except Exception as e:
                    print("error in training arima,{}",format(e))
